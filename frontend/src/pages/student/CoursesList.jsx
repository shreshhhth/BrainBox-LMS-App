...
const CoursesList = () => {
  ...
  return (
    <>
      <div className="relative md:px-36 px-8 pt-15 text-left">
        ...
        {
          input && <div className="inline-flex items-center text-xs gap-4 px-3 py-1.5 border rounded-full border-blue-600 mt-8 -mb-8 text-gray-800">
            <p>{input}</p>
