    ...
    <footer className='bg-black md:px-36 text-left w-full mt-10'>
      <div className='flex flex-col md:flex-row items-start px-8 md:px-0 justify-center gap-10 md:gap-20 py-10 border-b border-white/30'>
        <div className='flex flex-col md:items-start items-center w-full'>
          ...
          <p className='mt-6 text-center md:text-left text-sm  text-white/80'>BrainBox - Your Gateway to Knowledge Empowering students with a wide range of curated courses, designed to enhance learning and skill development. Unlock your potential with BrainBox today.</p>
          </div>
        ...
        <div className='hidden md:flex flex-col items-start w-full mt-5'>
            ...
            <p className=' text-sm  text-white/80'>Subscribe to our newsletter for expert insights, free resources, and the latest news on BrainBox</p>
      ...
      <p className='py-4 text-center text-xs md:text-sm text-white/80'>&copy; 2025 BrainBox. All rights reserved. | Designed with care by Shreshth </p>
    </footer>
  )
}
